      ...
      <div className="flex items-center gap-3">
        {transactions.length > 0 && (
          <div className="relative">
            <button
              className="w-12 h-12 flex items-center justify-center rounded-2xl bg-card border border-on-surface/5 dark:border-white/5 hover:border-accent/50 transition-all duration-300 shadow-sm dark:shadow-none cursor-pointer"
              aria-label="Ekspor Data"
              onClick={() => setExportOpen(!exportOpen)}
            >
              <Download className="h-5 w-5 text-on-surface/70" />
            </button>
            {exportOpen && (
              <>
        ...
        <Link
          ...
          aria-label="Analisis"
        >
          <BarChart3 className="h-5 w-5 text-on-surface/70" />
        </Link>
        <Link
          href="/settings"
          className="w-12 h-12 flex items-center justify-center rounded-2xl bg-card border border-on-surface/5 dark:border-white/5 hover:border-accent/50 transition-all duration-300 shadow-sm dark:shadow-none"
        ...
        >
          <Settings className="h-5 w-5 text-on-surface/70" />
        </Link>
        <button
